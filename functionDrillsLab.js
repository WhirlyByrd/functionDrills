...
console.log(exclaimThree('a string'))
...
let nameGreeting = nameCheck('Sylvia')
...
emailCheck('   kara.r.gardner@gmail.com   ')
...
//CODE HERE
const chocolateFrog = 3

function spendLimit(myGold){
  if(myGold >= chocolateFrog){
    totalFrogs = myGold/chocolateFrog
  }
  //let totalFrogs = spendMax
